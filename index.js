...
// House system Porphyry code
const HOUSE_SYSTEM = 'P';

swisseph.setSiderealMode(SIDEREAL_MODE);

// Helper: get sign name from degrees
...
// Calculate chart ruler from ascendant sign
const chartRulers = {
  Aries: 'Mars',
  Taurus: 'Venus',
  Gemini: 'Mercury',
...
app.post('/calculate', (req, res) => {
  ...
  swisseph.swe_calc_ut(jd, swisseph.SE_SUN, SE_SIDEREAL, (sunRes) => {
    ...
    swisseph.swe_calc_ut(jd, swisseph.SE_MOON, SE_SIDEREAL, (moonRes) => {
      ...
      // Ascendant calculation requires houses calculation, we pass latitude and longitude
